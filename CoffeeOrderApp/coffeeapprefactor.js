...
// let findOrderTextBox = document.getElementById("findOrderTextBox");
...
// //STEP FOUR: Find an order based on the email address provided

// findOrderButton.addEventListener("click", function () {
//   let email = findOrderTextBox.value;
...
//   findRequest.addEventListener("load", function () {
//     let coffeeOrders = JSON.parse(this.responseText);
//     console.log(coffeeOrders);

//     coffeeOrders.filter((email) => {
//         return ``
//       });
